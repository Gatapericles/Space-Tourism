...
function HomePage() {
  ...
  return (
    <>
      <div className="text-white sm:space-y-28 flex flex-col  my-10
                         justify-start  text-center h-[80vh] md:grid grid-cols-2 items-center md:mt-[00%]">
